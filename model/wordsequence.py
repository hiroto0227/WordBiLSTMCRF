...
class WordSequence(nn.Module):
    def __init__(self, data):
        ...
        self.input_size += self.sw_num * data.HP_sw_hidden_dim
    ...
    def forward(self, word_inputs, feature_inputs, word_seq_lengths, char_inputs, char_seq_lengths, char_seq_recover, sw_inputs, sw_lengths, sw_recovers, sw_fmasks, sw_bmasks):
        """
            input:
        ...
        """
        word_represent = self.wordrep(word_inputs,feature_inputs, word_seq_lengths, char_inputs, char_seq_lengths, char_seq_recover, sw_inputs, sw_lengths, sw_recovers, sw_fmasks, sw_bmasks)
